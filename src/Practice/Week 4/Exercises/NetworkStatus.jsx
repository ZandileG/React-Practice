...
Create an application (i.e. make a component) to detect and display when 
a user goes offline and comes back online (e.g. like MSTeams, Slack, Google Meet, etc.).
The correct solution to this exercise will show "🟢 Online" when you are connected to the 
internet, and show "🔴 Offline" when you are disconnected from the internet; so ensure you 
enable/disable your Wi-Fi to test if your code works.
...
Update the UI to display "🟢 Online" when the user is connected and "🔴 Offline" when disconnected 
(you can copy and paste these icons for use in your HTML).
