...
You are building a table component that fetches data from an API. 
The API supports pagination, and you want to fetch new data whenever the user changes the page 
(this is a standard feature in applications that display large datasets, 
like dashboards, e-commerce product lists, or admin panels).
...
You can use the API URL (https://jsonplaceholder.typicode.com/posts?_page=1&_limit=10) 
which limits the data response to 10 entries. 
